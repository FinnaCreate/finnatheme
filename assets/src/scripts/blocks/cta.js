...
const { PlainText, RichText, MediaUpload, BlockControls, InspectorControls, ColorPalette } = wp.editor
...
registerBlockType('gutenberg-awps/awps-cta', {
    ...
    edit({ attributes, className, setAttributes }) {
        const { title, body, backgroundImage, titleColor, bodyColor, overlayColor, overlayOpacity, url, buttonText } =
            attributes
    ...
    save({ attributes }) {
        const { title, body, titleColor, bodyColor, overlayColor, overlayOpacity, backgroundImage, url, buttonText } =
            attributes
