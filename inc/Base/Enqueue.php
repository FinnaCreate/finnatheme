...
class Enqueue
{
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_style('finna', $this->cache_bust('assets/build/css/app.css'), [], $theme->get('Version'));
        wp_enqueue_script('finna', $this->cache_bust('assets/build/js/app.js'), [], $theme->get('Version'));
     ...
     * @throws \Exception
     */
    public function cache_bust($path)
    {
        if (wp_get_environment_type() === 'production') {
            return get_stylesheet_directory_uri() . '/' . $path;
        }
