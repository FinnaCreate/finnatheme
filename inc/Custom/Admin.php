...
namespace Finna\Custom;

use Finna\Api\Settings;
use Finna\Api\Callbacks\SettingsCallback;
...
class Admin
{
    ...
    private function enqueue()
    {
        ...
        $pages = array('toplevel_page_finna');
    ...
    private function enqueue_faq(Settings $settings)
    {
        ...
        // Pages array to where enqueue scripts
        $pages = array('finna_page_finna_faq');
    ...
    private function settings()
    {
        ...
        $args = array(
            array(
                'option_group' => 'finna_options_group',
                'option_name' => 'first_name',
                'callback' => array($this->callback, 'finna_options_group')
            ),
            array(
                'option_group' => 'finna_options_group',
                'option_name' => 'finna_test2'
            )
        );
    ...
    private function sections()
    {
        ...
        $args = array(
            array(
                'id' => 'finna_admin_index',
                'title' => 'Settings',
                'callback' => array($this->callback, 'finna_admin_index'),
                'page' => 'finna'
            )
        );
