...
use Finna\Api\Customizer\Sidebar;
use Finna\Api\Customizer\Header;
use Finna\Api\Customizer\Footer;
...
class Customizer
{
    ...
    public function output()
    {
        ...
        echo self::css('#sidebar', 'background-color', 'finna_sidebar_background_color');
        echo self::css('.site-footer', 'background-color', 'finna_footer_background_color');
        echo self::css('.site-header', 'background-color', 'finna_header_background_color');
        echo self::css('.site-header', 'color', 'finna_header_text_color');
        echo self::css('.site-header a', 'color', 'finna_header_link_color');
